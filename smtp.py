...
def _smpt_enum():
    res=_scan(host,'-sV --script=smtp-commands.nse,smtp-strangeport.nse,smtp-open-relay.nse --script-args="smtp-open-relay.domain=sakurity.com,smtp-open-relay.ip=127.0.0.1"  -F')
